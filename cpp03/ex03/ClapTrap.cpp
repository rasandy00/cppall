...
/*   Updated: 2026/06/20 16:21:15 by liranaiv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << GREY << "[ ClapTrap default constructor ]\t"
...
ClapTrap::ClapTrap(const std::string& name): _name(name),
		_hitPoints(10), _energyPoints(10), _attackDamage(0)
{
	std::cout << GREY << "[ ClapTrap name constructor ]\t"
		<< "A wild " << _name << " appears!\n" << RESET;
}

ClapTrap::ClapTrap(const ClapTrap& other)
{
	std::cout << GREY << "[ ClapTrap copy constructor ]\t"
...
{
	std::cout << GREY << "[ ClapTrap copy assignment operator ]\t"
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	...
	std::cout << GREEN << "ClapTrap " << _name << " have been repaired, and got "
		<< amount << " hitPoints!\n" << RESET;
	_hitPoints += amount;
	if ((amount >= INT_MAX) || (_hitPoints < 0) || (_hitPoints > 100))
		_hitPoints = 100;
	_energyPoints--;
}
